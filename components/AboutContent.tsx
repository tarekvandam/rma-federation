...
const ar: typeof en = {
  ...
  aboutP2: 'أسس <strong class="text-white">طارق سيد إبراهيم</strong> اتحاد RMA في <strong class="text-red-400">2013</strong> لتحدي أساطير الفنون القتالية غير الواقعية وتعزيز مهارات القتال الفعالة.',
  ...
  founderTitle: 'طارق سيد<br /><span class="text-red-600">إبراهيم</span>',
  founderP1: 'فنان قتالي ومدرب دفاع عن النفس لديه سنوات من الخبرة القتالية، أسس طارق سيد إبراهيم <strong class="text-white">RMA</strong> في <strong class="text-red-400">2013</strong> لسد الفجوة بين القتال الخيالي والفعالية الواقعية.',
