...
const rules = [
  ...
  },
  {
    ...
    items: [
      "51 kg, 54 kg, 57 kg, 60 kg",
      "63.5 kg, 67 kg, 71 kg, 75 kg",
      "81 kg, 86 kg, 91 kg, +91 kg",
    ],
  ...
  },
  {
    ...
    items: [
      ...
      "Cadets: 1.5 min | Amateurs: 3 min | Professionals: 5 min",
  ...
  },
  {
    ...
    subs: [
      {
        subtitle: "Round One (Striking)",
        items: ["Allowed: Punches, Kicks", "Prohibited: Ground fighting"],
      },
      {
        subtitle: "Round Two (Grappling)",
        items: ["Limited to: Wrestling, Jiu-Jitsu", "Prohibited: All striking"],
      },
      {
        subtitle: "Round Three (Open Combat)",
        items: ["All techniques allowed: Striking, Takedowns, Ground fighting, Submissions"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subs: [
      {
        subtitle: "Legal Target Areas",
        items: ["From chest to thigh"],
      },
      {
        subtitle: "Head/Face Contact",
        items: ["Allowed: Kicks, Knees (without holding or clinch)", "Prohibited: Punches, Elbow strikes"],
      },
      {
        subtitle: "Ground Striking",
        items: ["Striking or kicking a grounded opponent is prohibited"],
      },
    ],
  },
  {
    ...
    content: null,
    items: [
      "Clean technical punch = 1 point",
      "Body kick = 1 point",
      "Head kick = 2 points",
      "Knee to the head (without clinch) = 2 points",
      "Technical takedown = 1 point",
      "Submission attempt = No points",
    ],
  },
  {
    num: "9",
  ...
  },
  {
    ...
    content: null,
    items: [
      "Allowed only in: Round Two & Round Three",
      "Ground engagement duration: 30 seconds",
      "If no effective action occurs, the referee stops and restarts from standing",
    ],
  },
  {
    num: "11",
  ...
  },
  {
    ...
    items: [
      ...
      "Third warning: 1 point deduction",
        ...
        <div className="flex justify-center gap-4 mb-14">
          <button
            ...
            className={`px-6 py-3 rounded-xl font-bold text-sm transition ${
              tab === "promotion" ? "bg-red-600 text-white" : "bg-zinc-900 text-gray-400 border border-zinc-800 hover:border-red-600/40"
            }`}
          >
            🥋 Promotion Program
          </button>
          <button
            ...
            className={`px-6 py-3 rounded-xl font-bold text-sm transition ${
              tab === "rules" ? "bg-red-600 text-white" : "bg-zinc-900 text-gray-400 border border-zinc-800 hover:border-red-600/40"
            }`}
          >
            📋 Official Rules
          </button>
          ...
          <>
            ...
            <section className="mb-16 bg-zinc-900/50 rounded-3xl p-8 border border-zinc-800">
              ...
              <p className="text-gray-400 mb-6 leading-8">
                This stage is one of the most important phases for a beginner practitioner. The athlete must learn essential fundamentals of combat.
              </p>
            ...
            <div className="space-y-4 mb-16">
              {beltLevels.map((belt) => (
                <div key={belt.color} className={`rounded-2xl border ${belt.bg} overflow-hidden transition`}>
                  <button
                    onClick={() => setBeltOpen(beltOpen === belt.color ? null : belt.color)}
            ...
            <section className="mb-16 bg-zinc-900/50 rounded-3xl p-8 border border-zinc-800">
              ...
              <p className="text-gray-400 mb-6 leading-8">
                This stage represents the true foundation of the practitioner and the beginning of specialization.
              </p>
