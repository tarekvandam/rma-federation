...
export const metadata = generateMetadata(
  ...
  "Founded in 2013 by Tarek Vandam, the World Real Martial Art Federation (RMA) is a global leader in martial arts, self-defense, combat sports, boxing, kickboxing, Muay Thai, MMA, and Jiu-Jitsu training with 87K Facebook followers and 81.1K YouTube subscribers.",
  "تأسس الاتحاد العالمي للفنون القتالية الحقيقية (RMA) في 2013 على يد طارق فندام، وهو رائد عالمي في تدريب الفنون القتالية والدفاع عن النفس والرياضات القتالية."
);
