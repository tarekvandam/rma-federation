...
export const translations = {
  en: {
    ...
    verify: {
      ...
      foundDesc: "This certificate is registered and authentic",
      notFound: "Certificate Not Found",
      notFoundDesc: "No certificate matches this ID. Please check and try again.",
      revoked: "Revoked Certificate",
      revokedDesc: "This certificate has been revoked and is no longer valid.",
      id: "Certificate ID",
      holder: "Holder Name",
      belt: "Belt",
      date: "Date",
  ...
  ar: {
      ...
      profiles: [
        {
          ...
          image: "/images/tarek.jpg",
          description: "مؤسس اتحاد RMA — طارق سيد إبراهيم — بخبرة 30 عامًا في الفنون القتالية الواقعية وأنظمة القتال. بنى الاتحاد على مبادئ القتال الأصيل، ويقود شهادات دولية ويدرب مقاتلين نخبة حول العالم.",
          stats: [
    ...
    verify: {
      ...
      title: "تحقق من صحة الشهادة",
      subtitle: "أدخل رقم الشهادة للتحقق من صحتها",
      placeholder: "مثال: RMA-2026-0001",
      verify: "تحقق",
      found: "شهادة صالحة",
      foundDesc: "هذه الشهادة مسجلة وأصلية",
      notFound: "الشهادة غير موجودة",
      notFoundDesc: "لا توجد شهادة بهذا الرقم. تحقق من الرقم وحاول مرة أخرى.",
      revoked: "شهادة ملغاة",
      revokedDesc: "هذه الشهادة تم إلغاؤها ولم تعد صالحة.",
      id: "رقم الشهادة",
      holder: "اسم الحاصل",
      belt: "الحزام",
      date: "التاريخ",
